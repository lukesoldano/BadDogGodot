...
func _on_energy_state_updated(old_state: PlayerEnergy.EnergyState, new_state: PlayerEnergy.EnergyState):
   const tired_max_velocity_ratio = 0.6
   const normal_max_velocity_ratio = 0.7
   const hyper_max_velocity_ratio = 0.8
